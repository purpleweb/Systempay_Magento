...
class Lyra_Systempay_Block_Oneclick_Product extends Mage_Catalog_Block_Product_View
{
    public function isOneclickAvailable()
    {
        ...
        if ($configContext != Lyra_Systempay_Helper_Payment::ONECLICK_LOCATION_PRODUCT
