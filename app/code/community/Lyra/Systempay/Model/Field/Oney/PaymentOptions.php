...
class Lyra_Systempay_Model_Field_Oney_PaymentOptions extends Lyra_Systempay_Model_Field_Array
{
    protected $_eventPrefix = 'systempay_field_oney_payment_options';
