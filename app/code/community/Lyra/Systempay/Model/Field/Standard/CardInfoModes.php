...
class Lyra_Systempay_Model_Field_Standard_CardInfoModes extends Mage_Core_Model_Config_Data
{
    ...
    {
        if ($this->error) {
            Mage::throwException(Mage::helper('systempay')->__('The card data entry on merchant site cannot be used without enabling SSL.'));
        }
