...
class Lyra_Systempay_Model_Payment_Cof3xcb extends Lyra_Systempay_Model_Payment_Abstract
{
    protected $_code = 'systempay_cof3xcb';
    protected $_formBlockType = 'systempay/cof3xcb';
    ...
    protected  function _setExtraFields($order)
    {
        ...
        $this->_systempayRequest->set('cust_title', $title);

        $testMode = $this->_systempayRequest->get('ctx_mode') == 'TEST';

        // override payment_cards
        $this->_systempayRequest->set('payment_cards', $testMode ? 'COF3XCB_SB' : 'COF3XCB');
    }
