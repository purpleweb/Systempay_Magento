...
class Lyra_Systempay_Model_Session extends Mage_Checkout_Model_Session
{
    ...
    /**
     * Get Systempay 1-Click quote instance by current session
     *
    ...
    public function getQuote()
    {
        if ($this->_quote === null) {
            ...
            // do not activate quote until the Systempay 1-Click button is clicked
