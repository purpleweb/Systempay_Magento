...
if (! class_exists('Lyra_Systempay_Model_Api_Response', false)) {

    /**
     * Class representing the result of a transaction (sent by the IPN URL or by the client return).
     */
    class Lyra_Systempay_Model_Api_Response
    {
         ...
         *
         * @see Lyra_Systempay_Model_Api_Api::sign
         * @var string
         */
        private $certificate;
        ...
        /**
         * Constructor for Lyra_Systempay_Model_Api_Response class.
        ...
        {
            $this->rawResponse = Lyra_Systempay_Model_Api_Api::uncharm($params);
        ...
        {
            return Lyra_Systempay_Model_Api_Api::sign($this->rawResponse, $this->certificate, $hashed);
        }
        ...
        /**
         * Check if the payment is to validate manually in the Systempay Back Office.
         * @return bool
         */
        ...
        {
            $currency = Lyra_Systempay_Model_Api_Api::findCurrencyByNumCode($this->get('currency'));
        ...
        /**
         * @deprecated Deprecated since version 1.2.1. Use <code>Lyra_Systempay_Model_Api_Response::getLogMessage()</code>
         * or <code>Lyra_Systempay_Model_Api_Response::getMessage()</code> instead.
         */
        ...
        /**
         * @deprecated Deprecated since version 1.2.0. Use <code>Lyra_Systempay_Model_Api_Response::getOutputForPlatform()</code> instead.
         */
        ...
        public function getOutputForPlatform($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(strtoupper($original_encoding), Lyra_Systempay_Model_Api_Api::$SUPPORTED_ENCODINGS) ?
