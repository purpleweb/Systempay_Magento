...
if (! class_exists('Lyra_Systempay_Model_Api_Request', false)) {

    /**
     * Class managing and preparing request parameters and HTML rendering of request.
     */
    class Lyra_Systempay_Model_Api_Request
    {

        /**
         * The fields to send to the Systempay platform.
         *
         * @var array[string][Lyra_Systempay_Model_Api_Field]
         * @access private
         */
        ...
        {
            // initialize encoding
            $this->encoding = in_array(strtoupper($encoding), Lyra_Systempay_Model_Api_Api::$SUPPORTED_ENCODINGS) ?
            ...
            $timestamp = time();
            $this->set('vads_trans_id', Lyra_Systempay_Model_Api_Api::generateTransId($timestamp));
        ...
        private function generateSignature($fields = null, $hashed = true)
        {
            ...
            return Lyra_Systempay_Model_Api_Api::sign($params, $this->getCertificate(), $hashed);
        }
         ...
         *
         * @return array[string][Lyra_Systempay_Model_Api_Field] a list of Lyra_Systempay_Model_Api_Field
         */
